...
const groups = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: "/admin/reddit-channels",
        label: "Reddit Channels",
        icon: (
          <svg className="w-4.5 h-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: (
          <svg className="w-4.5 h-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-5 5a2 2 0 01-2.828 0l-7-7A2 2 0 013 10V5a2 2 0 012-2z" />
          </svg>
        ),
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: "/admin/settings#email-settings",
...
export function AdminSidebar() {
  ...
  if (HIDE_SIDEBAR_ON.includes(pathname)) {
    return null;
  }
  return (
    <AppSidebar
